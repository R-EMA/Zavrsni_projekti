package graphs3_dots;

import processing.core.PApplet;

/**
 * zahteva Processing core.jar biblioteku !!!
 * (sličan postupak kao kod dodavanja podrške za MySQL)
 * 
...
* 
* PRILAGOĐENO
* Cilj je nacrtati kuću bez podizanja "olovke" i bez ponavljanja linija
* 
*/


public class ConnectDots extends PApplet{
	
	int dotColor = 192;
	int dotColorOver = 255;
	int dotColorClicked = 80;
	...
	public class Dot {
	  ...
	  public Dot(int localX, int localY) {
	    x = localX;
	    y = localY;
	    s = 20;
	    c = 192;
	...
	public class Line {
		  ...
		  public Line(int startDot, int endDot) {
	...
	public static void main(String[] args){
		String[] processingArgs = {"Draw House with connect dots"};
		ConnectDots cd = new ConnectDots();
		PApplet.runSketch(processingArgs, cd);
	}
